...
<body>
    ...
    <section class="checkout">
      ...
      ?>
                <p class="product-name"><span class="product-name"><?= $fetch_cart['name']; ?></span><span
                        class="price-items">₱<?= $fetch_cart['price']; ?> x <?= $fetch_cart['quantity']; ?></span></p>
                <?php
            }
         }else{
      ...
      ?>
            ...
            <div class="user-info">
                ...
                <a href="update_user.php" class="info">update info</a>
                ...
                <a href="update_address.php" class="add">update address</a>
